...
namespace HoliDayRental.DAL.Interfaces
{
    ...
    public interface IRepository<T, TKey> where T : IEntity<TKey>, new()
                                          where TKey : struct // par valeur (types primitifs) Id de type Tkey (type de la Primary Key)
    {
        ...
        /// </summary>
        /// <param name="criteria">un Func (délgué generique avec retour) pour tester si les records matchent</param>
